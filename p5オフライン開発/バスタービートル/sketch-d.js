...
function ui(){
  ...
  a_bulletsSpeed_slider = createSlider(0.1, 100, 25,0.1);
  ...
  a_scrollSpeed_slider = createSlider(0, 100, 20);
  a_scrollSpeed_slider.position(710, 130);
  a_scrollSpeed_slider.style('width', '200px');

  a_moveUD_slider = createSlider(0,100,5);
  a_moveUD_slider.position(710, 170);
  a_moveUD_slider.style('width', '200px');

  a_moveLR_slider = createSlider(0,100,5);
  a_moveLR_slider.position(710, 210);
  a_moveLR_slider.style('width', '200px');

  a_timer_slider = createSlider(60,600,180);
  a_timer_slider.position(710,290);
  a_timer_slider.style('width','200px');

  a2_bulletsSpeed_slider = createSlider(0.1, 100, 1,0.1);
  ...
  a2_scrollSpeed_slider = createSlider(0, 100, 5);
...
function draw(){
  ...
  if(timer_Accelerarion<a_timer_slider.value()){
  ...
  var timer_ps = floor((a_timer_slider.value()/60)*10)/10
  ...
  text("【加速時間設定】",550,280)
  text("acceleration time",550,300)
  text(timer_ps+" second",550,310)
