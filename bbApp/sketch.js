...
function mainGame() {
  ...
  if(h_boss2==="alive"){
    ...
    if(is_acceleration){
      ...
      let fc38 = frameCount/38;
      let fc40 = frameCount/40;

      v_armL.set(165 + (sin(fc38)*300),bosposY + 320 + (cos(fc38)*300));
      v_armR.set(200 + (cos(fc40)*300),bosposY + 320 + (sin(fc40)*300));
  ...
  fill(72,87,17)
  rect(730,43,map(p_hp_boss2,0,2000,0,300),26)
